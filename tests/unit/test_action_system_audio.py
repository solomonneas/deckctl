...
def test_volume_up_calls_platform_volume_up_with_step():
    ...
    with patch("deckctl.actions.system_audio.volume_up") as f:
...
def test_volume_down_passes_step():
    ...
    with patch("deckctl.actions.system_audio.volume_down") as f:
...
def test_volume_mute_no_args():
    ...
    with patch("deckctl.actions.system_audio.volume_mute") as f:
...
def test_media_play():
    ...
    with patch("deckctl.actions.system_audio.media_play") as f:
...
def test_media_pause():
    ...
    with patch("deckctl.actions.system_audio.media_pause") as f:
...
def test_media_next():
    ...
    with patch("deckctl.actions.system_audio.media_next") as f:
...
def test_media_prev():
    ...
    with patch("deckctl.actions.system_audio.media_prev") as f:
